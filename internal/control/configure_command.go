...
const nodeConfigSecureDir = "/etc/autostream-encoder-recorder"
...
func RunConfigureCommand(args []string, expectedType string, stdout io.Writer) error {
	...
	configPath := fs.String("config", "/etc/autostream-encoder-recorder/config.yml", "path to write config.yml")
